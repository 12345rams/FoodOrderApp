    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative flex-col justify-center items-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 tracking-tight">Join Antigravity</h1>
          <p className="text-slate-400 text-lg max-w-md mx-auto">Create your account to start automating your B2B WhatsApp orders instantly.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 animate-fade-in">
        <div className="w-full max-w-md">
          ...
          <form className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100" onSubmit={submit}>
            ...
            <button 
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium rounded-xl px-4 py-3 mt-6 transition-all shadow-md hover:shadow-lg hover:shadow-emerald-500/20 disabled:opacity-70 flex justify-center items-center gap-2"
            >
            ...
            <p className="text-center text-sm text-slate-500 mt-6">
              Already have an account? <Link to="/login" className="font-semibold text-slate-900 hover:text-emerald-600 transition-colors">Sign in</Link>
            </p>
          </form>
        </div>
      </div>
